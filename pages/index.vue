      ...
      <div id="detailsWrapper" class="w-full">
        <div class="section-heading text-center w-full fade-in">
          ...
          <h4 class="text-black pt-2 pb-8">
            ...
            <a href="/about"
              ><i
                class="las la-arrow-alt-circle-right text-primary text-2xl"
              ></i
            ></a>
          </h4>
        </div>
          ...
          <div id="details" class="sm:flex justify-between gap-x-20">
            <div class="grid-detail min-w-64 fade-in">
              <div class="">
                ...
                <p class="pt-4">
                  Our mission is to meet the health and fitness goals of our
                  members and guests in an environment that is friendly, clean,
                  welcoming and enjoyable for all ages.
                </p>
              </div>
            </div>
            <div class="grid-detail min-w-64 fade-in">
              <div class="">
                ...
                <p class="pt-4">
                  We provide a high-level luxury health club experience to our
                  members and guests, integrating cutting edge technology, the
                  best equipment and impeccable customer service.
                </p>
              </div>
            </div>
            <div class="grid-detail min-w-64 fade-in">
              <div class="">
                ...
                <p class="pt-4">
                  We are strongly committed to providing services for and
                  actively engaging our members in programs and activities for
      ...
      <div id="galleryWrapper ">
        ...
        <div id="mediaWrapper" class="embed-container w-full fade-in">
          <iframe
            ...
            width="800"
            height="700"
            src="https://www.youtube-nocookie.com/embed/VBm3UoxThrQ"
            frameborder="0"
